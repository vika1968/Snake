...
type snakeBodyCoordinates = { x: number, y: number }
let snakeBody: snakeBodyCoordinates[]
...
const btnStart = document.querySelector('button') as HTMLButtonElement;
...
const manageGame = () => {
  ...
  snakeBody.forEach((snakeElement: any, i: number) => {
...
function snakeManualControl(event: any) {
